...
def defence(char_name: str, char_class: str) -> str:
    """Отображение блокирования атаки."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Отображение применение специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Особенности выбранного персонажа и инструкция начала тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор персонажа, описание выбранного персонажа."""
    approve_choice: str = ''
    char_class: str = ''
